...
google.bookmarkbubble.Bubble.prototype.getIconUrl_ = function () {
    if (!this.iconUrl_) {
        ...
        if (!link || !(this.iconUrl_ = link.href)) {
            this.iconUrl_ = 'data:images/png;base64,';
        }
    }    
...
google.bookmarkbubble.Bubble.prototype.build_ = function () {
    ...
    if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
        bubbleInner.innerHTML = 'Add page to your home screen: ' +
        'just press the arrow below and choose <b>\'Add to homescreen\'</b>';
    } else {
        bubbleInner.innerHTML = 'Add page to your home screen: ' +
        'just press the arrow below and choose <b style="font-size:15px">+</b> och välj ' +
